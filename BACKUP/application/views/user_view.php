                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <!--    </div>-->
                                            <!--    <div class="col-md-6">-->
                                            <!--        <div class="form-group"><label class="mb-1"><b>No. Mesin Absen</b></label><input class="form-control py-4" id="fingerprintid" name="fingerprintid" type="text" placeholder="No. Mesin Absen" /></div>-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                            <div class="form-row">
                                                <div class="col-md-6">
