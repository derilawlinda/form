...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="<?=base_url()?>assets/img/P152.png" type="image/png">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4"><img src="<?=base_url()?>assets/img/avatar.png" height="50"></h3></div>
                                    <div class="card-body">
                                        <form action="<?= site_url('admin/login') ?>" method="POST">
                                            ...
                                            <!--</div>-->
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0"><input type="submit" class="btn btn-primary" value="Login"></div>
                                        </form>
                                    </div>
