                            ...
                            <div class="col-lg-7">
                                ...
                                <!--    <div class="card-header"><h3 class="text-center font-weight-light my-4"><img src="assets/img/avatar.png" height="50"></h3></div>-->
                                    <!--<div class="card-body">-->
                                        ...
                                        <?php if($role == 'crew'): ?>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group"><label class="mb-1"><b>Jabatan</b></label><input class="form-control py-4" id="jabatan" name="jabatan" type="text" value="<?php echo isset($temp_form->jabatan) ? $temp_form->jabatan : null; ?>" /></div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group"><label class="mb-1"><b>Status Lokasi</b></label><input class="form-control py-4" id="status_kerja" name="status_kerja" type="text" value="<?php echo isset($temp_form->status_kerja) ? $temp_form->status_kerja : null; ?>" /></div>
                                                </div>
                                            </div>
                                        <?php else: ?>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group"><label class="mb-1"><b>Status Lokasi</b></label>
                                                        <select class="form-control" name="status_lokasi">
                                                            <option>- Pilih Salah Satu -</option>
                                                            <option value="OFT">OFF Duty</option>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small">Data yang telah di konfirmasi akan di review oleh Admin / Spv & User / Customer.</div>
                                    </div>
                                <!--</div>-->
                            </div>
                        </div>
