            ...
            <div id="layoutSidenav_content">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('admin/confirmed/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">
				...
				<?php else: ?>
                    ...
                    <!--                        </div>-->
                                            ...
                                            <!--    </div>-->
                                            <!--</div>-->
                                            <div class="form-group mt-4 mb-0"><button type="submit" class="btn btn-success btn-block">Validasi Data</button></div>
						</form>
				<?php endif; ?>
